...
query_no_complexity='{"query":"{\n  hero{\n    name\n  }\n}","variables":{},"operationName":null}'
query_middle_complexity='{"query":"query{\n  hero(episode: JEDI){\n    id\n    name\n    appearsIn\n    secretBackstory\n    friends{\n      id\n      name\n      ... on Droid{\n        appearsIn\n        primaryFunction\n      }\n      ... on Human{\n        appearsIn\n        secretBackstory\n      }\n      ... HumanFragment\n    }\n  }\n}\n\nfragment HumanFragment on Human{\n\tid\n    name\n    appearsIn\n    secretBackstory\n    friends{\n      id\n      name\n      ... on Droid{\n        appearsIn\n        primaryFunction\n      }\n      ... on Human{\n        appearsIn\n        secretBackstory\n      }\n    }\n}","variables":{},"operationName":null}'
query_high_complexity='{"query":"query{\n  human(id:\"1001\"){\n    ... HumanFragment\n  }\n  droid(id:\"2001\"){\n  \t... DroidFragment\n  }\n  hero(episode: JEDI){\n    id\n    name\n    appearsIn\n    secretBackstory\n    friends{\n      id\n      name\n      ... on Droid{\n        appearsIn\n        primaryFunction\n      }\n      ... on Human{\n        appearsIn\n        secretBackstory\n      }\n      ... HumanFragment\n    }\n  }\n}\n\nfragment HumanFragment on Human{\n\tid\n    name\n    appearsIn\n    secretBackstory\n    friends{\n      id\n      name\n      ... on Droid{\n        appearsIn\n        primaryFunction\n        friends{\n          ... CharacterFragment\n        }\n      }\n      ... on Human{\n        appearsIn\n        secretBackstory\n        friends{\n          ... CharacterFragment\n        }\n      }\n    }\n}\n\nfragment DroidFragment on Droid{\n\tid\n    name\n    appearsIn\n    primaryFunction\n    friends{\n      id\n      name\n      ... on Droid{\n        appearsIn\n        primaryFunction\n        friends{\n          ... CharacterFragment\n        }\n      }\n      ... on Human{\n        appearsIn\n        secretBackstory\n        friends{\n          ... CharacterFragment\n        }\n      }\n    }\n}\n\nfragment CharacterFragment on Character{\n  id\n  name\n  friends{\n    name\n  }\n}","variables":{},"operationName":null}'
query_introspection='{"query":"query IntrospectionQuery {\n            __schema {\n              queryType { name }\n              mutationType { name }\n              subscriptionType { name }\n              types {\n                ...FullType\n              }\n              directives {\n                name\n                description\n                args {\n                  ...InputValue\n                }\n              }\n            }\n          }\n        \n          fragment FullType on __Type {\n            kind\n            name\n            description\n            fields(includeDeprecated: true) {\n              name\n              description\n              args {\n                ...InputValue\n              }\n              type {\n                ...TypeRef\n              }\n              isDeprecated\n              deprecationReason\n            }\n            inputFields {\n              ...InputValue\n            }\n            interfaces {\n              ...TypeRef\n            }\n            enumValues(includeDeprecated: true) {\n              name\n              description\n              isDeprecated\n              deprecationReason\n            }\n            possibleTypes {\n              ...TypeRef\n            }\n          }\n        \n          fragment InputValue on __InputValue {\n            name\n            description\n            type { ...TypeRef }\n            defaultValue\n          }\n        \n          fragment TypeRef on __Type {\n            kind\n            name\n            ofType {\n              kind\n              name\n              ofType {\n                kind\n                name\n                ofType {\n                  kind\n                  name\n                }\n              }\n            }\n          }","variables":{},"operationName":"IntrospectionQuery"}'
...
do
  ...
  for i in $(seq "$max_iteraion")
  do
    random_number=$RANDOM%10000
    temp_query="#$random_number\n$query"
    echo -ne "url: $url | iteration: $i/$max_iteraion\r"
